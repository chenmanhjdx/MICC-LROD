...
model = dict(
    ...
    roi_head=dict(
        ...
        top_k=7,
        with_atten=False,
        cluster_mode='mil_cls',
        with_objectness=False,
        with_detail_branch=True,
        detail_feat_dim=256,
        ...
        bbox_head1=dict(
            ...
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=det_loss_weight),
            loss_bbox=dict(type='L1Loss', loss_weight=det_loss_weight)),
        bbox_head=dict(
...
load_from = ''
work_dir = '../work_dirs/MICC-LROD/DIOR/'
